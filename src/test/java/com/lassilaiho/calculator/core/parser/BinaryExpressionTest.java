...
public class BinaryExpressionTest {
    ...
    public void equalWhenSameOperatorAndOperands() {
        var left =
            new BinaryExpression(new NumberNode(-2), Operator.ADD, new NumberNode(6));
        var right =
            new BinaryExpression(new NumberNode(-2), Operator.ADD, new NumberNode(6));
    ...
    public void notEqualWhenLeftOperandDifferent() {
        var left =
            new BinaryExpression(new NumberNode(-1), Operator.ADD, new NumberNode(6));
        var right =
            new BinaryExpression(new NumberNode(-2), Operator.ADD, new NumberNode(6));
    ...
    public void notEqualWhenDifferentOperator() {
        var left = new BinaryExpression(new NumberNode(-2), Operator.MULTIPLY,
            new NumberNode(6));
        var right =
            new BinaryExpression(new NumberNode(-2), Operator.ADD, new NumberNode(6));
        assertFalse(left.equals(right));
